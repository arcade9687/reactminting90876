    ...
    <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black">
      ...
      <div className=" grid h-screen grid-cols-1 lg:grid-cols-12">
        ...
        <div className="flex items-center justify-center w-full h-full col-span-1 lg:col-span-7">
          <div className="bg-black  text-White-300 flex flex-col w-full max-w-xl gap-4 p-12 rounded-3xl lg:border lg:border-gray-400 lg:dark:border-gray-800">
            ...
            <div className="flex flex-col gap-2 xs:gap-4">
              {isLoading ? (
                ...
                >
                  <div className="w-full">
                    <div className="w-24 h-10 bg-yellow-500 rounded-xl dark:yellow-500"></div>
                  </div>
                </div>
              ) : isOpenEdition ? null : (
                <p>
                  <span className="text-4xl font-bold text-green-500  xs:text-2xl lg:text-3xl font-apple body-font ">
                    Minted
                  </span>
                  <span className="text-4xl font-bold text-yellow-500  xs:text-2xl lg:text-5xl font-style: italic">
                    {numberClaimed}
                  </span>{" "}
                  <span className="text-xl font-bold text-white-500  xs:text-xl lg:text-2xl">
                    / {numberTotal}
                  </span>
                </p>
              )}
              <h1 className="text-2xl font-bold line-clamp-1 xs:text-3xl lg:text-4xl">
                {contractMetadata.isLoading ? (
                  ...
                  >
                    <div className="w-full">
                      <div className="w-48 h-8 bg-gray-200 rounded-xl dark:bg-gray-700"></div>
                    </div>
              ...
              {contractMetadata.data?.description ||
                contractMetadata.isLoading ? (
                  <div className="font-apple hover:text-red-500 text-white-100 text-xl line-clamp-2">
                  {contractMetadata.isLoading ? (
                    <div
                      role="status"
                        className="space-y-8 animate-pulse md:flex md:items-center md:space-x-8 md:space-y-0"
                    >
                      <div className="w-full">
                        <div className="mb-2.5 h-4 max-w-[480px] rounded-md bg-gray-200 dark:bg-gray-700"></div>
                        <div className="mb-2.5 h-4 rounded-md bg-gray-200 dark:bg-gray-700"></div>
                      </div>
                      <span className="sr-only">Loading...</span>
                    </div>
                  ) : (
                ...
                <span className="text-gray-500">
                  Drop is starting soon. Please check back later.
                    ...
                    <div className="flex flex-col w-full gap-4">
                      <div className="flex flex-col w-full gap-4 lg:flex-row lg:items-center lg:gap-20 ">
                        <div className="flex w-full px-2 border border-gray-900 rounded-lg h-11 dark:border-white-800 md:w-full">
                      <button
                        onClick={() => {
                          ...
                          if (value > maxClaimable) {
                            ...
                            className="flex items-center justify-center h-full px-2 text-2xl text-center rounded-l-md disabled:cursor-not-allowed disabled:text-white-500 dark:text-white dark:disabled:text-gray-600"
                        disabled={isSoldOut || quantity - 1 < 1}
                      >
                        ➖
                      </button>
                          <p className="flex items-center justify-center w-full h-full font-Applebold text-2xl font-bold text-center dark:text-white lg:w-full">
                    ...
                    <Web3Button
                      ...
                      onSuccess={() => {
                        toast({
                          title: "Successfully minted GO SEE THEM QUICK",
                          description:
                            "Your Sovereign whale(s) is(are) transfered to your wallet",
                          duration: 10000,
